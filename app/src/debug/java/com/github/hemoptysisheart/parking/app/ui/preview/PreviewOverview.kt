...
object PreviewOverview {
    val OVERVIEW_DRIVE_신주쿠역_TO_ECOLO_PARK_KABUKICHO_29 = Overview(
        listOf(
    ...
    val OVERVIEW_WALKING_ECOLO_PARK_KABUKICHO_29_TO_패밀리마트_카부키쵸키타점 = Overview(
        listOf(
